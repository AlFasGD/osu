...
namespace osu.Game.Rulesets.Osu.Beatmaps
{
    public class KeijoBeatmapProcessor : BeatmapProcessor
    {
        ...
        private void applyStacking(Beatmap<KeijoHitObject> beatmap, int startIndex, int endIndex)
        {
            ...
            if (endIndex < beatmap.HitObjects.Count - 1)
            {
                ...
                for (int i = endIndex; i >= startIndex; i--)
                {
                    ...
                    {
                        KeijoHitObject stackBaseObject = beatmap.HitObjects[stackBaseIndex];
                        if (stackBaseObject is Spinner) break;

                        KeijoHitObject objectN = beatmap.HitObjects[n];
            ...
            for (int i = extendedEndIndex; i > startIndex; i--)
            {
                ...
                KeijoHitObject objectI = beatmap.HitObjects[i];
                    ...
                    while (--n >= 0)
                    {
                        ...
                        if (objectN is Slider && Vector2Extensions.Distance(objectN.EndPosition, objectI.Position) < stack_distance)
                        {
                            ...
                            for (int j = n + 1; j <= i; j++)
                            {
                                ...
                                KeijoHitObject objectJ = beatmap.HitObjects[j];
        ...
        private void applyStackingOld(Beatmap<KeijoHitObject> beatmap)
        {
            for (int i = 0; i < beatmap.HitObjects.Count; i++)
            {
                KeijoHitObject currHitObject = beatmap.HitObjects[i];
