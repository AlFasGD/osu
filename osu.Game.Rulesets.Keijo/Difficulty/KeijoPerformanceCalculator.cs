...
namespace osu.Game.Rulesets.Keijo.Difficulty
{
    ...
    {
        public new KeijoDifficultyAttributes Attributes => (KeijoDifficultyAttributes)base.Attributes;
        ...
        public override double Calculate(Dictionary<string, double> categoryRatings = null)
        {
            ...
            if (mods.Any(m => m is KeijoModNoFail))
                multiplier *= 0.90f;

            if (mods.Any(m => m is KeijoModSpunOut))
                multiplier *= 0.95f;
        ...
        private double computeAimValue()
        {
            ...
            if (mods.Any(m => m is KeijoModTouchDevice))
            ...
            if (mods.Any(h => h is KeijoModHidden))
                aimValue *= 1.0f + 0.04f * (12.0f - Attributes.ApproachRate);

            if (mods.Any(h => h is KeijoModFlashlight))
            {
        ...
        private double computeSpeedValue()
        {
            ...
            if (mods.Any(m => m is KeijoModHidden))
        ...
        private double computeAccuracyValue()
        {
            ...
            if (mods.Any(m => m is KeijoModHidden))
                accuracyValue *= 1.08f;
            if (mods.Any(m => m is KeijoModFlashlight))
                accuracyValue *= 1.02f;
