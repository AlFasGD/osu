...
namespace osu.Game.Rulesets.Keijo.UI
{
    public class KeijoPlayfield : Playfield
    {
        ...
        private readonly JudgementContainer<DrawableKeijoJudgement> judgementLayer;
        private readonly ConnectionRenderer<KeijoHitObject> connectionLayer;

        public static readonly Vector2 BASE_SIZE = new Vector2(512, 384);

        protected override GameplayCursorContainer CreateCursor() => new KeijoCursorContainer();

        public KeijoPlayfield()
        {
            InternalChildren = new Drawable[]
            {
                ...
                judgementLayer = new JudgementContainer<DrawableKeijoJudgement>
                {
                    RelativeSizeAxes = Axes.Both,
                    Depth = 1,
                },
        ...
        {
            connectionLayer.HitObjects = HitObjectContainer.Objects.Select(d => d.HitObject).OfType<KeijoHitObject>();
        }
        ...
        private void onNewResult(DrawableHitObject judgedObject, JudgementResult result)
        {
            ...
            DrawableKeijoJudgement explosion = new DrawableKeijoJudgement(result, judgedObject)
            {
                Origin = Anchor.Centre,
                Position = ((KeijoHitObject)judgedObject.HitObject).StackedEndPosition,
                Scale = new Vector2(((KeijoHitObject)judgedObject.HitObject).Scale * 1.65f)
            };
