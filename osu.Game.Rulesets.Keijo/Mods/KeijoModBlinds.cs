...
{
    public class KeijoModBlinds : Mod, IApplicableToDrawableRuleset<KeijoHitObject>, IApplicableToScoreProcessor
    {
        ...
        public class DrawableKeijoBlinds : Container
        {
            ...
            private readonly Beatmap<KeijoHitObject> beatmap;
