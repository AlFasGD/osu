...
{
    internal class KeijoModTransform : Mod, IApplicableToDrawableHitObjects
    {
        ...
        public override Type[] IncompatibleMods => new[] { typeof(KeijoModWiggle) };
        ...
        public void ApplyToDrawableHitObjects(IEnumerable<DrawableHitObject> drawables)
        {
            ...
            {
                var hitObject = (KeijoHitObject)drawable.HitObject;
