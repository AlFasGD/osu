...
{
    internal class KeijoModWiggle : Mod, IApplicableToDrawableHitObjects
    {
        ...
        public override Type[] IncompatibleMods => new[] { typeof(KeijoModTransform) };
        ...
        {
            var osuObject = (KeijoHitObject)drawable.HitObject;
